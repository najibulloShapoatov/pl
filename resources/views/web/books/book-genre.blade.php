    ...
    <div class="content-body">
        ...
        <div class="row ">
            <div class="col-sm-12 ">
                ...
                <div class="col-12 col-lg-auto mb-10 mt-25 genre">
                    ...
                    <div class="mt-20">
                        @if(count($cat[0]['cats2lvl']) > 0)
                            @foreach($cat[0]['cats2lvl'] as $item)
                                <span class=" lib-category mr-15"><a href="{{ url('/book-sub-category/' . $item->id) }}">{{ $item->title }}</a></span>
                            @endforeach
                        @endif
                    </div>
                </div><!-- Page Heading End -->
        ...
        <div class="row e-mats">
            <div class="col-sm-12 pl-10 ematt">
                ...
                @if(count($cat[0]['books']) > 0)
                    @foreach($cat[0]['books'] as $item)
                    <div class="emat-item">
