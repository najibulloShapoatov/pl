                        ...
                        <table class="table table-bordered table-hover m-0">
                            ...
                            @foreach($news as $item)
                                <tr id="adm_table_item_{{ $item->id }}">
                                    <th scope="row">
                                        @if(!empty($item->image))
                                            <img style="border: 1px solid #ccc;" src="/public/uploads/news/{{ $item->id . '/' .$item->image}}" width="75" >
                                        @else
                                            @lang('lang.no_image')
                                        @endif
                                    </th>
                                    ...
                                    <td>
                                        <label  data-id="{{ $item->id }}" id="change_news_active" class="adomx-switch">
                                    ...
                                    <td class="text-center adm-table-notification" width="170">
                                        <a href="{{ url('/news-manage/edit/' . $item->id) }}" class="editableIcons mr-10" title="@lang('lang.edit')">
                                            <span class="ti-pencil"></span>
                                        </a>
                                        <span data-id="{{ $item->id }}" id="delete_item_news" class="ti-trash"></span>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
