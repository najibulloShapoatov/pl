            ...
            <div class="col-sm-12">
                @if(count($faqCats) > 0)
                            ...
                            @foreach($faqCats as $item)
                                <tr id="adm_table_item_{{ $item->id }}">
                                    ...
                                    <td class="text-center adm-table-notification" width="170">
                                        <span data-id="{{ $item->id }}" id="edit_cat_faq" class=" edit-item ti-pencil mr-10 "></span>
                                        <span data-id="{{ $item->id }}" id="delete_item_faqCat" class=" remove-item  ti-trash"></span>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                        ...
                        <form  class="todo-list-add-new mt-30" data-date="false">
                            ...
                            <input id="new_faq_c_title" class="content" type="text" placeholder="@lang('lang.add_category')">
                            <button id="add_faq_cat_btn" class=" button button-outline button-primary ">
