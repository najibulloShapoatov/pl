                            ...
                            @foreach($data as $item)
                                <tr id="adm_table_item_{{ $item->id }}">
                                    ...
                                    <td class="text-center adm-table-notification" width="170">
                                        <span data-id="{{ $item->id }}" id="edit_cat_bGenre" class=" edit-item ti-pencil mr-10 "></span>
                                        <span data-id="{{ $item->id }}" id="delete_item_bGenre" class=" remove-item  ti-trash"></span>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
{{--                        {!! $data->links() !!}--}}
            ...
            <form  class="todo-list-add-new mt-30" data-date="false">
                ...
                <input id="add_genre_book_text" class="content" type="text" placeholder="@lang('lang.add_genre')">
                <button id="add_genre_book_btn" class=" button button-outline button-primary ">
