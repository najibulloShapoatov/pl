    ...
    <div class="content-body">
        ...
        <div class="row">
            ...
            <form  class="todo-list-add-new mt-30" data-date="false">
                ...
                <input id="add_category_book_text" class="content" type="text" placeholder="@lang('lang.add_categroy')">
                <button id="add_category_book_btn" class=" button button-outline button-primary ">
