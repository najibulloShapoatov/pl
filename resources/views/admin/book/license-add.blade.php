        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-lg-auto mb-20 d-flex justify-content-between ">
                <div class="page-heading d-flex">
                    <h3>@lang('lang.adding_license')</h3>
        ...
        <div class="col-md-8 ">
            ...
            <div class="row mbn-15">
                ...
                <div class="col-12 pl-0 mb-15">
                    <input  id="add_bLicense_title"  type="text" class="form-control" placeholder="@lang('lang.enter_name_license')">
                </div>
                ...
                <div class="col-12 pl-0 mb-15">
                    <textarea id="add_bLicense_descr"  class="form-control" placeholder="@lang('lang.about_license')"></textarea>
                </div>
                <div class="col-12 pl-0 mb-15">
                    <button id="add_bLicense_btn" class="button button-primary button-outline fl-right">@lang('lang.save')</button>
                </div>
            </div>
        </div>
