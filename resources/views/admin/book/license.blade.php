                            ...
                            @foreach($data as $item)
                                <tr id="adm_table_item_{{ $item->id }}">
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <img width="70px" height="60px"  src="/public/uploads/books/licenses/{{ $item->id . '/' . $item->image }}" alt="">
                                    </td>
                                    @else
                                    ...
                                    <td class="text-center adm-table-notification" width="170">
                                        <a href="{{ url('/book-license/' . $item->id) }}">
                                            <span  class=" edit-item ti-pencil mr-10 "></span>
                                        </a>
                                        <span data-id="{{ $item->id }}" id="delete_item_blicense" class=" remove-item  ti-trash"></span>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
